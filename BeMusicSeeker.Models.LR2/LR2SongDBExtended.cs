...
public sealed class LR2SongDBExtended : LR2SongDB
{
	...
	public class ir_score : SQLiteTable<ir_score>
	{
		...
		protected LR2ScoreDB.score.ClearType _clear;
		...
		public LR2ScoreDB.score.ClearType clear
		{
			get
			{
				if ((option & 0x10) != 0 && _clear == LR2ScoreDB.score.ClearType.FC)
				{
					return LR2ScoreDB.score.ClearType.PA;
				}
				return _clear;
			}
			set
			{
				if (value == LR2ScoreDB.score.ClearType.PA)
				{
					_clear = LR2ScoreDB.score.ClearType.FC;
				}
				_clear = value;
			}
		}
	...
	public class ir_data : SQLiteTable<ir_data>
	{
		...
		public LR2ScoreDB.score.ClearType clear { get; set; }
