...
public partial class MainWindowViewModel : ViewModel
{
    ...
    private void ApplyPlayHistoryView(MainViewUpdateMode mode, MainViewUpdateMode requestedMode, object parameter, Stopwatch viewBuildStopwatch)
    {
        ...
        PlayHistoryPeriodSummaryOverride summaryOverride = activePlayHistoryProvider == PlayHistoryProvider.Beatoraja
            ...
            : null;
        PlayHistoryReadPresentationBuildResult buildResult = playHistoryWorkflowOwner.BuildReadPresentation(
        ...
        try
        {
            applyResult = playHistoryWorkflowOwner.ApplySortedRows(
                new PlayHistorySortedRowsApplyRequest(
                    ...
                    SnapshotSelectedPlayHistorySummaryFilterKeys(),
                    archivePeriodTree),
                viewBuildStopwatch,
                MainChartList,
                PlaylistWorkspace,
