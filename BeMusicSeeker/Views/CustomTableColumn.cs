...
internal static class CustomTableColumnFactory
{
    ...
    private static CustomTableColumn[] CreateAllPlaylistSummaryColumns(PlaylistSummaryColumnSettings settings)
    {
        ...
        [
            ...
            new CustomTableColumn("Name", "NAME", settings.Name, 2, nameof(PlaylistSummaryRow.Name), TextAlignment.Left, row => GetString(row, nameof(PlaylistSummaryRow.Name))),
            new CustomTableColumn("Symbol", "SYMBOL", settings.Symbol, 3, nameof(PlaylistSummaryRow.Symbol), TextAlignment.Center, row => GetString(row, nameof(PlaylistSummaryRow.Symbol)), autoTrimTooltip: false),
            new CustomTableColumn("LastUpdate", "LAST UPDATE", settings.LastUpdate, 4, nameof(PlaylistSummaryRow.LastUpdate), TextAlignment.Center, row => FormatDateTime(GetValue(row, nameof(PlaylistSummaryRow.LastUpdate)))),
            new CustomTableColumn("TotalCharts", "TOTAL", settings.TotalCharts, 5, nameof(PlaylistSummaryRow.TotalCharts), TextAlignment.Right, row => GetString(row, nameof(PlaylistSummaryRow.TotalCharts))),
            new CustomTableColumn("OwnedCharts", "OWNED", settings.OwnedCharts, 6, nameof(PlaylistSummaryRow.OwnedCharts), TextAlignment.Right, row => GetString(row, nameof(PlaylistSummaryRow.OwnedCharts))),
            new CustomTableColumn("MissingCharts", "MISSING", settings.MissingCharts, 7, nameof(PlaylistSummaryRow.MissingCharts), TextAlignment.Right, row => GetString(row, nameof(PlaylistSummaryRow.MissingCharts))),
            new CustomTableColumn("OwnedRatio", "OWNED %", settings.OwnedRatio, 8, nameof(PlaylistSummaryRow.OwnedRatio), TextAlignment.Right, row => FormatPercentOne(GetValue(row, nameof(PlaylistSummaryRow.OwnedRatio)))),
            new CustomTableColumn("Link", "LINK", settings.Link, 9, null, TextAlignment.Center, row => GetPlaylistSummaryLinkText(row), tooltipSelector: GetPlaylistSummaryLinkTooltip, cellKind: CustomTableCellKind.ActionText, editTextSelector: GetPlaylistSummaryLinkTooltip),
            new CustomTableColumn("IsExternalSync", "SYNC", settings.IsExternalSync, 10, nameof(PlaylistSummaryRow.IsExternalSync), TextAlignment.Center, row => string.Empty, checkedSelector: row => GetNullableBool(row, nameof(PlaylistSummaryRow.IsExternalSync)), cellKind: CustomTableCellKind.CheckBox, autoTrimTooltip: false),
            new CustomTableColumn("Status", Resources.Playlist_summary_status_header, settings.Status, 11, nameof(PlaylistSummaryRow.StatusSortOrder), TextAlignment.Center, row => GetString(row, nameof(PlaylistSummaryRow.Status)), tooltipSelector: row => GetString(row, nameof(PlaylistSummaryRow.StatusDetail))),
            new CustomTableColumn("IsRootFolder", "ROOT", settings.IsRootFolder, 12, nameof(PlaylistSummaryRow.IsRootFolder), TextAlignment.Center, row => string.Empty, checkedSelector: row => GetNullableBool(row, nameof(PlaylistSummaryRow.IsRootFolder)), cellKind: CustomTableCellKind.CheckBox, autoTrimTooltip: false),
            new CustomTableColumn("BmtSort", "BMT SORT", settings.BmtSort, 13, nameof(PlaylistSummaryRow.BmtSort), TextAlignment.Right, row => GetString(row, nameof(PlaylistSummaryRow.BmtSort)), autoTrimTooltip: false),
            new CustomTableColumn("IsBmtOutput", "BMT OUTPUT", settings.IsBmtOutput, 14, nameof(PlaylistSummaryRow.IsBmtOutput), TextAlignment.Center, row => string.Empty, checkedSelector: row => GetNullableBool(row, nameof(PlaylistSummaryRow.IsBmtOutput)), cellKind: CustomTableCellKind.CheckBox, autoTrimTooltip: false)
        ];
    }
