...
internal static class CustomTableColumnFactory
{
    ...
    private static CustomTableColumn[] CreateAllPlaylistSummaryColumns(PlaylistSummaryColumnSettings settings)
    {
        ...
        [
            ...
            new CustomTableColumn("CompatPrefix", "PREFIX", settings.CompatPrefix, 3, nameof(PlaylistSummaryRow.CompatPrefix), TextAlignment.Left, row => GetString(row, nameof(PlaylistSummaryRow.CompatPrefix)), editPropertyName: nameof(PlaylistSummaryRow.CompatPrefix), autoTrimTooltip: false),
            new CustomTableColumn("Symbol", "SYMBOL", settings.Symbol, 4, nameof(PlaylistSummaryRow.Symbol), TextAlignment.Center, row => GetString(row, nameof(PlaylistSummaryRow.Symbol)), editPropertyName: nameof(PlaylistSummaryRow.Symbol), autoTrimTooltip: false),
            new CustomTableColumn("LastUpdate", "LAST UPDATE", settings.LastUpdate, 5, nameof(PlaylistSummaryRow.LastUpdate), TextAlignment.Center, row => FormatDateTime(GetValue(row, nameof(PlaylistSummaryRow.LastUpdate)))),
            new CustomTableColumn("TotalCharts", "TOTAL", settings.TotalCharts, 6, nameof(PlaylistSummaryRow.TotalCharts), TextAlignment.Right, row => GetString(row, nameof(PlaylistSummaryRow.TotalCharts))),
            new CustomTableColumn("OwnedCharts", "OWNED", settings.OwnedCharts, 7, nameof(PlaylistSummaryRow.OwnedCharts), TextAlignment.Right, row => GetString(row, nameof(PlaylistSummaryRow.OwnedCharts))),
