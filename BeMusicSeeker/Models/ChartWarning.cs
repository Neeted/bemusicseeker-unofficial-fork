...
internal sealed class ChartWarningDefinition
{
    ...
    internal static ChartWarningDefinition ForKind(ChartWarningKind kind)
    {
        return kind switch
        {
            ...
            ChartWarningKind.InstallEstimationLowConfidence => new ChartWarningDefinition(ChartWarningCategory.InstallEstimation, 46, Resources.WarningDigest_InstallEstimationLowConfidence, highlightRow: true),
