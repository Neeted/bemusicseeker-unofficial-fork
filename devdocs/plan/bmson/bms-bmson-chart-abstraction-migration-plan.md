...
- playlist library index は BMSLibrary 側に md5 / sha256 辞書 cache と currentness 管理を持つ。source chart ref は owned collection から作り、ViewModel は snapshot 取得 / prewarm task / readiness 表示だけを担い、`BMSFiles` / `BmsonSongs` を直接結合しない
