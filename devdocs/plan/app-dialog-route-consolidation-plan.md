...
着手時点では `DispatcherMessageBox.Show`、Livet `InteractionMessage` / `ConfirmationMessage`、
`CommonOpenFileDialogInteractionMessageAction`、`ProgressDialog.Execute`、各 View の `ShowDialog()` 直呼び、
`System.Windows.MessageBox.Show` 直呼びが混在していた。個別不具合に対して最小差分の修正を重ねた結果、
...
| Unit 6 picker bridge removal | `dotnet build BeMusicSeeker.sln /p:Configuration=Release --no-restore` | Passed | 0 warnings, 0 errors. |
| Unit 6 picker bridge removal | `dotnet test BeMusicSeeker.Tests\BeMusicSeeker.Tests.csproj --filter "DialogRouteConsolidationTests\|MainWindowContextMenuResourceTests" /p:Configuration=Release --no-restore` | Passed | 100 tests passed. |
| Unit 6 picker bridge removal | `dotnet format whitespace BeMusicSeeker.sln --verify-no-changes --no-restore --verbosity minimal` | Passed | no whitespace changes required. |
| Unit 6 picker bridge removal | `dotnet roslynator analyze BeMusicSeeker.sln --properties Configuration=Release --severity-level warning --verbosity minimal` | Passed | 0 diagnostics. |
| Unit 6 picker bridge removal | sub-agent static review | Passed | Final review returned no High / Medium findings. Low doc freshness note was fixed in `devdocs/spec/file-selection-dialogs.md`. |
| Unit 6 modal window route | `dotnet build BeMusicSeeker.sln /p:Configuration=Release --no-restore` | Passed | 0 warnings, 0 errors. |
| Unit 6 modal window route | `dotnet test BeMusicSeeker.Tests\BeMusicSeeker.Tests.csproj --filter "DialogRouteConsolidationTests\|MainWindowContextMenuResourceTests" /p:Configuration=Release --no-restore` | Passed | 101 tests passed. |
| Unit 6 modal window route | `dotnet format whitespace BeMusicSeeker.sln --verify-no-changes --no-restore --verbosity minimal` | Passed | no whitespace changes required. |
| Unit 6 modal window route | `dotnet roslynator analyze BeMusicSeeker.sln --properties Configuration=Release --severity-level warning --verbosity minimal` | Passed | 0 diagnostics. |
| Unit 6 modal window route | sub-agent static review | Passed | Final review returned no High / Medium findings. |
| Unit 7 view code-behind route | `dotnet build BeMusicSeeker.sln /p:Configuration=Release --no-restore` | Passed | 0 warnings, 0 errors. |
| Unit 7 view code-behind route | `dotnet test BeMusicSeeker.Tests\BeMusicSeeker.Tests.csproj --filter "DialogRouteConsolidationTests\|MainWindowContextMenuResourceTests" /p:Configuration=Release --no-restore` | Passed | 102 tests passed. |
| Unit 7 view code-behind route | `dotnet format whitespace BeMusicSeeker.sln --verify-no-changes --no-restore --verbosity minimal` | Passed | no whitespace changes required. |
| Unit 7 view code-behind route | `dotnet roslynator analyze BeMusicSeeker.sln --properties Configuration=Release --severity-level warning --verbosity minimal` | Passed | 0 diagnostics. |
| Unit 7 view code-behind route | sub-agent static review | Passed | Final review returned no High / Medium findings. |
| Unit 7 ViewModel dispatcher route | `dotnet build BeMusicSeeker.sln /p:Configuration=Release --no-restore` | Passed | 0 warnings, 0 errors. |
| Unit 7 ViewModel dispatcher route | `dotnet test BeMusicSeeker.Tests\BeMusicSeeker.Tests.csproj --filter "DialogRouteConsolidationTests\|MainWindowContextMenuResourceTests" /p:Configuration=Release --no-restore` | Passed | 103 tests passed. |
...
| Unit 7 legacy adapter removal | `dotnet build BeMusicSeeker.sln /p:Configuration=Release --no-restore` | Passed | 0 warnings, 0 errors. |
| Unit 7 legacy adapter removal | `dotnet test BeMusicSeeker.Tests\BeMusicSeeker.Tests.csproj --filter "DialogRouteConsolidationTests\|BmsLibraryDialogRoutingTests\|BmsLibraryMutationBoundaryTests" /p:Configuration=Release --no-restore` | Passed | 23 tests passed. |
...
| Unit 6 typed UI interaction route | `dotnet build BeMusicSeeker.sln /p:Configuration=Release --no-restore` | Passed | 0 warnings, 0 errors. |
| Unit 6 typed UI interaction route | `dotnet test BeMusicSeeker.Tests\BeMusicSeeker.Tests.csproj --filter "DialogRouteConsolidationTests\|MainWindowContextMenuResourceTests" /p:Configuration=Release --no-restore` | Passed | 104 tests passed. |
...
- XAML action bridge と code-behind 直呼びを coordinator に寄せる。
...
- `DispatcherMessageBox` と `UiDialogLegacyAdapter` は通常 route から完全削除する。
- `BmsLibraryDialogService` は legacy adapter を経由せず、coordinator route を直接使う。
