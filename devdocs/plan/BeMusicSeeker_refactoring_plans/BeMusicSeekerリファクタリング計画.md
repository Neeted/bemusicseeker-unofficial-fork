...
| C | [P0-02 BMSLibrary facade](./P0-02_BMSLibrary_ドメインFacade化計画.md) | `BMSLibrary` を compatibility facade として薄くする | `REF-MVP-C102` completed checkpoint / 次は `REF-MVP-C103` auto rename batch workflow seam |
...
1. Lane C 後続候補: `REF-MVP-C103` として `ApplyAutoRenamePlans` の batch workflow seam を切る。
