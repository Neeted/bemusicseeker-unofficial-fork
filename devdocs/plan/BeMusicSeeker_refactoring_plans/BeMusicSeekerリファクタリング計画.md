...
| C | [P0-02 BMSLibrary facade](./P0-02_BMSLibrary_ドメインFacade化計画.md) | `BMSLibrary` を compatibility facade として薄くする | `REF-MVP-C98` completed checkpoint / 次は `REF-MVP-C99` inline chart info workflow seam |
...
1. Lane C 後続候補: `REF-MVP-C99` として `BuildAndPersistInlineChartInfoForInstalledCharts` の workflow seam を切る。
