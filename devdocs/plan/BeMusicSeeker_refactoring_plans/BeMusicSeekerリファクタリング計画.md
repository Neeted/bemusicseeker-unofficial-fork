...
| C | [P0-02 BMSLibrary facade](./P0-02_BMSLibrary_ドメインFacade化計画.md) | `BMSLibrary` を compatibility facade として薄くする | `REF-MVP-C99` completed implementation / 次は `REF-MVP-C100` owned helper aftermath checkpoint |
...
1. Lane C 後続候補: `REF-MVP-C100` として C99 後に残る owned helper を再確認し、次に実装する 1 seam だけを選ぶ。
