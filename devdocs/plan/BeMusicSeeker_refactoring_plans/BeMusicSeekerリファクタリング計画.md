...
| C | [P0-02 BMSLibrary facade](./P0-02_BMSLibrary_ドメインFacade化計画.md) | `BMSLibrary` を compatibility facade として薄くする | `REF-MVP-C101` completed implementation / 次は `REF-MVP-C102` owned helper aftermath checkpoint |
...
1. Lane C 後続候補: `REF-MVP-C102` として C101 後に残る owned helper を再確認し、次に実装する 1 seam だけを選ぶ。
