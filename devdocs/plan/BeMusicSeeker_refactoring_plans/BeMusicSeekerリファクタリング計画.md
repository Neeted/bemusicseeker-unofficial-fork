...
| C | [P0-02 BMSLibrary facade](./P0-02_BMSLibrary_ドメインFacade化計画.md) | `BMSLibrary` を compatibility facade として薄くする | `REF-MVP-C43` completed checkpoint / 次は `REF-MVP-C44` maintenance hydration coordinator seam |
...
1. Lane C 後続候補: `REF-MVP-C44` として maintenance hydration の queue / worker lifecycle を coordinator seam へ移す。
