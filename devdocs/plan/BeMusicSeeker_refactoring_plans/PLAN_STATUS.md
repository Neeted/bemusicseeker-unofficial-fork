...
- execution anchor: `P3 PACKAGE-CLOSURE`
...
| `P3 PACKAGE-CLOSURE` | active | selected profileのpublish／layout／update contract | profile、scripts、validators、tests、spec、台帳を一貫更新 |
