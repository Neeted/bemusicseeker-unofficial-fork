...
- execution anchor: `P3 STARTUP-INDEX-GC-COMPONENTS`
...
| `P3 STARTUP-INDEX-GC-COMPONENTS` | active | synthetic可能なsong-table／resource-health、GC／startup instrumentation |
