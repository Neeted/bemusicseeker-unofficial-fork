...
| C: BMSLibrary domain facade 化 | `REF-MVP-C49: folder/file operation follow-up boundary review` | completed checkpoint | [P0-02](./P0-02_BMSLibrary_ドメインFacade化計画.md) |
