...
| `APP-01` | `DIRECT_FIX`／`LIKELY_OPTIMIZATION` | catalog same-version copy、drop-install progress queue、playlist lifecycle generic busをowner単位で解消 | final artifactの実データ確認 | `F6`／user |
