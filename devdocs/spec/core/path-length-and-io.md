...
| --- | --- | --- |
| 完全走査と不完全入力の保護、個別失敗の継続 | [`LibraryFileScanPipelineOwner`](../../../BeMusicSeeker/Models/BmsLibraryInternal/LibraryFileScanPipelineOwner.cs)、[`BmsLibraryInitializationService`](../../../BeMusicSeeker/Models/BmsLibraryInternal/BmsLibraryInitializationService.cs) | [`RootFileEnumerationTests`](../../../BeMusicSeeker.Tests/RootFileEnumerationTests.cs)、[`LibraryFileScanPipelineOwnerTests`](../../../BeMusicSeeker.Tests/LibraryFileScanPipelineOwnerTests.cs)、[`BmsLibraryInitializationFileScanTests`](../../../BeMusicSeeker.Tests/BmsLibraryInitializationFileScanTests.cs) |
| 安全な単一ファイル保存、書込み終了後の公開、一次失敗の保持 | [`AtomicFileWriter`](../../../BeMusicSeeker/Models/Utils/AtomicFileWriter.cs) | [`AtomicFileWriterTests`](../../../BeMusicSeeker.Tests/AtomicFileWriterTests.cs)、[`LR2ConfigTests`](../../../BeMusicSeeker.Tests/LR2ConfigTests.cs)、[`PlaylistWorkspacePersistenceCommandTests`](../../../BeMusicSeeker.Tests/PlaylistWorkspacePersistenceCommandTests.cs) |
| Explorerの事前解決と一回だけの副作用 | [`ExplorerOpenService`](../../../BeMusicSeeker/Models/Utils/ExplorerOpenService.cs) | [`ExplorerOpenServiceTests`](../../../BeMusicSeeker.Tests/ExplorerOpenServiceTests.cs) |
| 実際の譜面移転とファイル操作境界 | [`LibraryMutationOwner`](../../../BeMusicSeeker/Models/BMSLibrary.LibraryMutationOwner.cs) | [`BmsLibraryCatalogRelocationTests`](../../../BeMusicSeeker.Tests/BmsLibraryCatalogRelocationTests.cs)、[`BmsLibraryLibraryFileOperationsServiceTests`](../../../BeMusicSeeker.Tests/BmsLibraryLibraryFileOperationsServiceTests.cs) |
