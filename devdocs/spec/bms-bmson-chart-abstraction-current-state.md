...
5. テストと docs を cleanup する。production で使われない互換 API をテストのために残さず、adapter materialization を検証したい場合も BMS storage owner の代表ケースだけにする。
