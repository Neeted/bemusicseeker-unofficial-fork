...
2026-05-23 の resource health 境界整理後の確認では、`song_tbl_load_projection readMs=3311`、`everything_scan totalMs=17835`、`song_tbl_file_check_breakdown scan_ms=17884 apply_ms=247 instl_dst_cleanup_ms=152`、`init_library total_ms=19051`、`startup_ready_operable elapsedMs=21445`、初回 `main_view_build totalMs=1069`、初回 `custom_table_render renderWorkMs=150 rowHighlightMs=34`、`startup_background_summary elapsedMs=40756` であり、抽象化作業前の期待値（Everything scan 後数秒で operable）からの regression は出ていない。
