...
設定画面とLR2詳細画面は `SettingsControls` から共通辞書へ接続します。設定画面の既存キーは `BasedOn` で対応する共通スタイルを参照し、設定画面内にだけ既定スタイルを置きます。その他の独自ダイアログは共通辞書を直接使います。辞書やテンプレートを画面ごとに複製しません。
...
| 設定の表示部品、アクセシビリティ、候補幅、即時反映と取消 | [`SettingsWindow`](../../../BeMusicSeeker/Views/SettingsWindow.cs)、[`SettingsField`](../../../BeMusicSeeker/Views/Settings/SettingsPresentationControls.cs)、[`SettingsSection`](../../../BeMusicSeeker/Views/Settings/SettingsPresentationControls.cs) | [`SettingsWindowPresentationTests`](../../../BeMusicSeeker.Tests/SettingsWindowPresentationTests.cs)、[`SettingsWindowCompiledBehaviorTests`](../../../BeMusicSeeker.Tests/SettingsWindowCompiledBehaviorTests.cs)、[`SettingsForegroundInteractionTests`](../../../BeMusicSeeker.Tests/SettingsForegroundInteractionTests.cs)、[`SettingsDialogBehaviorTests`](../../../BeMusicSeeker.Tests/SettingsDialogBehaviorTests.cs) |
