...
| プレイリスト詳細 | `PlaylistDetailSourceRow` + `PlaylistDetailVirtualView` | playlist source-row sort | playlist identity、score snapshot、chart info index | `EntryLevel` など playlist 専用列を含むため通常 registry とは別契約 |
