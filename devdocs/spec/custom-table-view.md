...
| warning 系通常一覧列 | `LibraryChartRow` fallback | 既存 materialized sort | warning projection 依存が未整理 | `WarningDigestText` は resource health projection 合成があるため別設計にする |
