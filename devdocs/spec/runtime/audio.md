...
| --- | --- | --- |
| ロード、操作の受付、世代と解放の所有 | [`BassAudioRuntime`](../../../Ribbit/Media/Audio/BassAudioRuntime.cs)、[`BassAudioSession`](../../../Ribbit/Media/Audio/BassAudioSession.cs) | [`BassNativeRuntimeTests`](../../../BeMusicSeeker.Tests/BassNativeRuntimeTests.cs)、[`BassAudioSessionTests`](../../../BeMusicSeeker.Tests/BassAudioSessionTests.cs)、[`BassCollectibleLoadContextTests`](../../../BeMusicSeeker.Tests/BassCollectibleLoadContextTests.cs) |
| 機器の列挙、保存値、方式ごとの交渉と代替 | [`BassAudioRuntime`](../../../Ribbit/Media/Audio/BassAudioRuntime.cs) | [`AudioDeviceCatalogTests`](../../../BeMusicSeeker.Tests/AudioDeviceCatalogTests.cs)、[`BassAudioDeviceEnumerationTests`](../../../BeMusicSeeker.Tests/BassAudioDeviceEnumerationTests.cs)、[`BassAsioNegotiationTests`](../../../BeMusicSeeker.Tests/BassAsioNegotiationTests.cs)、[`BassWasapiAndDirectSoundNegotiationTests`](../../../BeMusicSeeker.Tests/BassWasapiAndDirectSoundNegotiationTests.cs) |
| ミキサー所属、再生世代、ネイティブ失敗 | [`BassAudioPlayer`](../../../Ribbit/Media/BassAudioPlayer.cs) | [`BassMixerSourceControllerTests`](../../../BeMusicSeeker.Tests/BassMixerSourceControllerTests.cs)、[`BassAudioSessionTests`](../../../BeMusicSeeker.Tests/BassAudioSessionTests.cs) |
| 効果の対応と引数ABI | [`BassAudioPlayer`](../../../Ribbit/Media/BassAudioPlayer.cs) | [`BassAudioEffectTests`](../../../BeMusicSeeker.Tests/BassAudioEffectTests.cs)、[`AudioContractsTests`](../../../BeMusicSeeker.Tests/AudioContractsTests.cs) |
| 進行と自然終了、最新要求、設定と失敗表示 | [`AudioDeviceTestWorkflowOwner`](../../../BeMusicSeeker/ViewModels/AudioDeviceTestWorkflowOwner.cs) | [`AudioDeviceTestWorkflowOwnerTests`](../../../BeMusicSeeker.Tests/AudioDeviceTestWorkflowOwnerTests.cs)、[`SettingsDialogBehaviorTests`](../../../BeMusicSeeker.Tests/SettingsDialogBehaviorTests.cs) |
