...
- **メンテナンス機能の強化**
  - LR2 非対応パス、ゼロノート検索、解析エラー、構成ファイルフルスキャン、重複ファイルチェックなど、状態確認用の画面を拡充しています。
- **UI・ログ・多言語対応**
...
10. `.wav` と `.ogg` が重複して存在している場合にどちらかに寄せる機能
