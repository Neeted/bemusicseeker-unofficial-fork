...
public sealed class PlaylistViewPipelineTests
{
    ...
    public void PlaylistDetailBuildState_SourceText_OwnsWorkerQueueState()
    {
        ...
        StringAssert.Contains(workflowCoordinatorSource, "internal static bool RebuildPlaylistSource(");
        StringAssert.Contains(workflowCoordinatorSource, "host.WaitPlaylistDetailBuildGate(cancellationToken);");
        StringAssert.Contains(workflowCoordinatorSource, "host.TryResolvePlaylistSelection(mode, parameter, out BMSTable bmsTable, out string folderName");
        ...
        StringAssert.Contains(workflowCoordinatorSource, "var completionResult = new PlaylistDetailBuildCompletionResult");
        StringAssert.Contains(workflowCoordinatorSource, "host.FinalizePlaylistDetailBuild(viewBuildStopwatch, completionResult);");
        StringAssert.Contains(workflowCoordinatorSource, "void FinalizePlaylistDetailBuild(Stopwatch viewBuildStopwatch, PlaylistDetailBuildCompletionResult completionResult);");
        ...
        StringAssert.Contains(workflowHostSource, "return PlaylistDetailBuildWorkflowCoordinator.ApplyPlaylistViewWithoutSourceRebuild(this, request, cancellationToken);");
        StringAssert.Contains(workflowHostSource, "return PlaylistDetailBuildWorkflowCoordinator.RebuildPlaylistSource(this, request, cancellationToken);");
        StringAssert.Contains(workflowHostSource, "playlistDetailBuildState.BuildGate.Wait(cancellationToken);");
        StringAssert.Contains(workflowHostSource, "playlistDetailBuildState.BuildGate.Release();");
        StringAssert.Contains(workflowHostSource, "return TryResolvePlaylistSelection(mode, parameter, out bmsTable, out folderName, out filterType);");
        ...
        Assert.AreEqual(-1, rootSource.IndexOf("private bool ApplyPlaylistViewWithoutSourceRebuild(", StringComparison.Ordinal));
